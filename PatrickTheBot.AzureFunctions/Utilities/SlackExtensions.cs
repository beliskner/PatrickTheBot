...
public static class SlackExtensions
{
    ...
    public static string ToPointsLevel(this WalletTableEntity walletTableEntity, Department department) 
        => (department is Department.Backend ? walletTableEntity.BackendPoints : walletTableEntity.FrontendPoints) switch
        {
